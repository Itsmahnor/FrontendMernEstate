...
export default function CreateListing() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const newImages = [...uploadedImages, ...res.data.images];
      setUploadedImages(newImages.slice(0, 6)); // Limit max 6
      setFiles([]);
    } catch (err) {
      ...
      <form className='flex gap-4 flex-col sm:flex-row' onSubmit={handleSubmit}>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          <p className='font-semibold'>
            Images (required, max 6): {uploadedImages.length}/6
          </p>
          <div className='flex gap-4'>
            ...
            <button
              ...
              disabled={files.length === 0 || uploadedImages.length >= 6}
