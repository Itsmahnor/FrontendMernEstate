...
const DeleteUser = async () => {
  ...
  try {
    const res = await fetch(`https://backendmernestate-production-8366.up.railway.app/api/user/delete/${id}`, {
      method: "DELETE",
      credentials: "include"
    });
...
const handleDelete = async (listingId) => {
  ...
  try {
    const res = await axios.delete(`https://backendmernestate-production-8366.up.railway.app/api/listing/delete/${listingId}`, {
...
const getListing = async () => {
  try {
    const res = await axios.get(`https://backendmernestate-production-8366.up.railway.app/api/listing/getList/${id}`, {
      withCredentials: true,
    });
